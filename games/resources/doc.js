...
//Construction Zone  BEEP BEEP
    var athens = new Resource("Athens", "A center for the arts, learning and philosophy. A powerful city-state protected only by a wooden wall.");
    var sparta = new Resource("Sparta", "Unique in ancient Greece for its social system and constitution. A society with all social institutions focused on military training and physical development.");
    var thebes = new Resource("Thebes", "The largest city of the ancient region of Boeotia and was the leader of the Boeotian confederacy. A major rival to Athens and Sparta.");
...
//End of Construction Zone BEEP BEEP    
    ...
    $('.resource-card').click(function () {     
        ...
        if(playerReady){
            ...
            console.log("turn mod " + turnCounter % 2);
