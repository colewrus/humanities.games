...
//Construction Zone  BEEP BEEP
    ...
    turn1.addCard("Every man, a warrior", "Spartans only raised citizen sons born without defect and dedicated their lives to training. However they maintained strong diplomacy to deploy their warriors only when necessary.", resources[1]);
    ...
    turn2.addCard("Isolation. Walls may protect from siege but vassals protect from invasion", "Thebes was centrally located and used control over neighboring villages and cities to protect itself", resources[2]); 
