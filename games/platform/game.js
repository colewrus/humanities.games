...
//PLATFORMS
    ...
    platforms.create(32*4, this.physics.world.bounds.height-48,'ground').setScale(8, 3).refreshBody();   //1 
    platforms.create(this.game.canvas.width-32*5, this.physics.world.bounds.height-48, 'ground').setScale(10,3).refreshBody(); //2
    console.log("Physics world bounds " , this.physics.world.bounds.height);
